...
*.*   = %ROOT%\Accessory\images; %ROOT%\Accessory\resources; %ROOT%\Accessory\libsrc\win; %ROOT%\Accessory\template\win; .\Buttons; .\InputFields; .\Splash; .\Wallpapers; .\Resources; .\Extras; .\Images; .\Panels; .\Theme
